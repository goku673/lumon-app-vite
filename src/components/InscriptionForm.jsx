...
const InscriptionForm = ({
  ...
  // Estados para manejar el flujo de carga masiva
  ...
  //  Función principal para carga masiva de competidores
  ...
  return (
    <>
      ...
      <div className="min-h-screen max-w-[1400px] mx-auto lg:px-16">
        ...
        {/* 🔥 Modal para mostrar resultado de carga masiva */}
        <Modal
        ...
        {/* 🔥 Modal de pago para carga masiva */}
        <BulkPaymentModal
        ...
        {/* Modal de pago individual (mantener para registro uno por uno) */}
        <PaymentModal
